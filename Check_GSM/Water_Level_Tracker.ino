...
delay(500);
Serial.println("AT+CMGS=\"+254xxxxxxxxxx\"\r"); // Replace x with user's mobile number
delay(1000);
...
Serial.println("AT+CMGF=1");
delay(500);
Serial.println("AT+CMGS=\"+254xxxxxxxxxx\"\r"); // Replace x with mobile number
delay(1000);
Serial.print("Time: ");
delay(10);
Serial.print(tim);
...
if (check == 1)
{
Serial.println("AT+CNMI=2,2,0,0,0"); // for sending SMS
delay(1000);
Serial.println("AT+CMGF=1");
delay(500);
Serial.println("AT+CMGS=\"+254xxxxxxxxxx\"\r"); // Replace x with mobile number
